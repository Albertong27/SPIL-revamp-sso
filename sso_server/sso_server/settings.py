...
SECRET_KEY = 'django-insecure-a3ilvfmo$_f=v1k_r*i4%)d#*1b1es)h#@9*5!-tp#^k-=7+rs'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # This allows Django to automatically search in each app's "templates" folder.
        'OPTIONS': {
            'context_processors': [
